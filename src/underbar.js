  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    if (Array.isArray(collection)){
      var total = accumulator === undefined ? collection.shift() : accumulator;
        ...
        for (var key in collection){
            var total = iterator(total,collection[key]);
        }
      }
      return total;

      // Recursive solution is possible here.
    };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(total, number) {
      if (!total) {
        ...
        return Boolean(iterator(number));
      }
    }, true);
